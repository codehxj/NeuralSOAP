...
def download_data(data_dir: str):
    ...
    print("Downloading QM9 raw data...")
    urllib.request.urlretrieve(RAW_URL, path_data_zip, reporthook=show_progress)
    print("\nExtracting...")
    ...
    urllib.request.urlretrieve(RAW_URL2, path_data_3195404, reporthook=show_progress)
    print("\nDone.")
